...
const STEP_LABEL: Record<TidyStepName, { short: string; full: string }> = {
  ...
  joined: {
    short: "Join",
    full: "Games each club filed against a stand-in for the other, made one game between them",
  },
  ...
  merged: {
    short: "Merge",
    full: "One opponent entered twice under one name, age and year by one state's clubs, made one",
  },
  claimed: {
    short: "Claim",
